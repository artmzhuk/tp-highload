...
- [Расчётно-пояснительная записка](#--)
   ...
   * [MVP](#mvp)
      + [Функционал MVP](#-mvp)
      + [Ключевые функциональные решения](#---1)
   * [Продуктовые метрики](#-)
   * [Технические метрики](#--1)
   * [Глобальная балансировка нагрузки](#---2)
      + [Расположение ДЦ](#--2)
      + [GeoDNS](#geodns)
      + [Anycast](#anycast)
      + [CDN](#cdn)
   * [Локальная балансировка нагрузки](#---3)
      + [Схема балансировки входящих запросов](#----1)
      + [Схема балансировки внутренних запросов](#----2)
   * [Логическая схема БД](#---4)
      + [Размеры данных                                                ](#--3)
