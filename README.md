...
| **Микросервис**      | **Средний RPS** | **Пиковый RPS** |
|-----------------------|-----------------|-----------------|
| Поиск                | 5,428.8         | 16,286.4        |
| Просмотр жилья       | 3,485.3         | 10,455.8        |
| Бронирование         | 884.7           | 2,654.2         |
| Профиль пользователя | 442.4           | 1,327.1         |
| Отзывы               | 3,485.3         | 10,857.9        |
| Чаты                 | 905.0           | 2,715.0         |
| Рекомендации         | 891.4           | 2,674.2         |
| **Итого**            | **15,523.9**    | **46,855.6**    |

- **Суммарный средний RPS**: 15,523.9  
- **Суммарный пиковый RPS**: 46,855.6
